...
class ContractUseCase {
    ...
    async createContract(params) {
        return await this.contractService.createContract(params.templateId, params.clientId, params.fields, params.note, params.fee, params.deposit, params.generatedBy);
    }
