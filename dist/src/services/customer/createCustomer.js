...
const buildCustomerPayload_1 = __importDefault(require("./buildCustomerPayload"));
const createCustomerInQuickBooks_1 = __importDefault(require("./createCustomerInQuickBooks"));
const saveQboCustomerId_1 = __importDefault(require("./saveQboCustomerId"));
const upsertInternalCustomer_1 = __importDefault(require("./upsertInternalCustomer"));
const supabase = (0, supabase_js_1.createClient)(process.env.SUPABASE_URL, process.env.SUPABASE_ANON_KEY);
const userRepository = new supabaseUserRepository_1.SupabaseUserRepository(supabase);
async function createCustomer(params) {
    ...
    // 1) Build payload
    const { fullName, payload } = (0, buildCustomerPayload_1.default)(firstName, lastName, email);
    // 2) Upsert internal record
    await (0, upsertInternalCustomer_1.default)(internalCustomerId, fullName, email);
