...
exports.getInvoices =
  exports.quickBooksDisconnect =
  exports.quickBooksStatus =
  exports.createCustomer =
  exports.getInvoiceableCustomersController =
  exports.createInvoice =
  exports.handleQuickBooksCallback =
  exports.connectQuickBooks =
  exports.quickBooksAuthUrl =
    void 0;
const quickbooksAuthService_1 = require('../services/auth/quickbooksAuthService');
const createCustomer_1 = __importDefault(
  require('../services/customer/createCustomer')
);
const createInvoice_1 = __importDefault(
  require('../services/invoice/createInvoice')
);
const supabase_1 = __importDefault(require('../supabase'));
// ← 1) Import your invoiceable-customers logic
const getInvoiceableCustomers_1 = __importDefault(
  require('../services/customer/getInvoiceableCustomers')
);
...
const getInvoiceableCustomersController = async (_req, res, next) => {
  try {
    const customers = await (0, getInvoiceableCustomers_1.default)(
      supabase_1.default
    );
    res.json(customers);
  } catch (err) {
