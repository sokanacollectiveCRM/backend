...
class ClientController {
    ...
    async updateClientStatus(req, res) {
        ...
        try {
            const { client, activity } = await this.clientUseCase.updateClientStatus(clientId, status, req.user?.id);
            res.json({
                success: true,
                client: {
                    id: client.id,
    ...
    async updateClient(req, res) {
        ...
        try {
            const { client, activity } = await this.clientUseCase.updateClientProfile(id, updateData, req.user?.id);
            res.json({
                success: true,
                client: {
                    id: client.id,
    ...
    async createActivity(req, res) {
        ...
        try {
            const activity = await this.clientUseCase.createActivity(id, type, description, metadata, req.user?.id);
            res.json({
                success: true,
                activity: {
                    id: activity.id,
