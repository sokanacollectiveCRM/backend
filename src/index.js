...
exports.userRepository = exports.userController = exports.requestFormController = exports.emailController = exports.contractController = exports.clientController = exports.authService = exports.authController = void 0;
...
//-----------------------------------------------
const userRepository = new supabaseUserRepository_1.SupabaseUserRepository(supabase_1.default);
exports.userRepository = userRepository;
const requestRepository = new requestFormRepository_1.RequestFormRepository(supabase_1.default);
const clientRepository = new supabaseClientRepository_1.SupabaseClientRepository(supabase_1.default);
const activityRepository = new supabaseActivityRepository_1.SupabaseActivityRepository(supabase_1.default);
//-----------------------------------------------
// Services (External Integrations)
//-----------------------------------------------
const authService = new supabaseAuthService_1.SupabaseAuthService(supabase_1.default, userRepository);
exports.authService = authService;
const requestService = new RequestFormService_1.RequestFormService(requestRepository);
const contractService = new supabaseContractService_1.SupabaseContractService(supabase_1.default);
//-----------------------------------------------
...
const clientUseCase = new clientUseCase_1.ClientUseCase(clientRepository, activityRepository);
...
const requestFormController = new requestFormController_1.RequestFormController(requestService);
...
const contractController = new contractController_1.ContractController(contractUseCase);
