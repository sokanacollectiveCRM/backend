...
clientRoutes.get(
  ...
  (req, res) => index_1.userController.getAllTeamMembers(req, res)
);
clientRoutes.delete(
  '/team/:id',
  authMiddleware_1.default,
  (req, res, next) => (0, authorizeRoles_1.default)(req, res, next, ['admin']),
  (req, res) => index_1.userController.deleteMember(req, res)
);
clientRoutes.post(
  '/team/add',
  authMiddleware_1.default,
  (req, res, next) => (0, authorizeRoles_1.default)(req, res, next, ['admin']),
  (req, res) => index_1.userController.addTeamMember(req, res)
);
...
clientRoutes.get(
  ...
  authMiddleware_1.default,
  (req, res, next) =>
    (0, authorizeRoles_1.default)(req, res, next, ['admin', 'client']),
  (req, res) => index_1.clientController.exportCSV(req, res)
);
clientRoutes.get(
  '/',
  authMiddleware_1.default,
...
clientRoutes.get(
  ...
  (req, res) => index_1.clientController.getClientById(req, res)
);
clientRoutes.put(
  '/status',
  authMiddleware_1.default,
...
clientRoutes.put(
  ...
  (req, res, next) =>
    (0, authorizeRoles_1.default)(req, res, next, ['admin', 'doula']),
  (req, res) => index_1.clientController.updateClient(req, res)
);
clientRoutes.post(
  '/:id/activity',
  authMiddleware_1.default,
  (req, res, next) =>
    (0, authorizeRoles_1.default)(req, res, next, ['admin', 'doula']),
  (req, res) => index_1.clientController.createActivity(req, res)
);
