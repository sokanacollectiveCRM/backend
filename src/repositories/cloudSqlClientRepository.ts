...
function mapRowToClient(row: Record<string, any>): Client {
  ...
  const user = new User({
    ...
    home_type: row.home_types ?? row.home_type,
    home_types: row.home_types,
    home_type_other: row.home_type_other,
    home_access: row.home_access,
    home_adults_count: row.home_adults_count,
    home_youth_count: row.home_youth_count,
