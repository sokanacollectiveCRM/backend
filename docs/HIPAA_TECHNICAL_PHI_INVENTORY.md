...
| ID     | Finding                                                                                                                                  | Severity                                                                         |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| INV-01 | Public intake emails **full clinical + identity payload** to staff Gmail                                                                 | **P0 — Closed 2026-08-25** (HIPAA-13F; `docs/HIPAA_13F_VERIFICATION_SIGNOFF.md`) |
...
2. Remove FE `console.log` of client update payloads (`updateClient.ts` and
   siblings); close birth-outcomes assignment (INV-12); **doula-assignment
   email minimized (HIPAA-05)** — client match email remains separate.
