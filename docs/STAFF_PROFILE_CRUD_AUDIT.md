...
**Date:** 2026-08-14  
**Context:** Admin Account/Profile save appeared to succeed but did not persist
because staff rows live in Cloud SQL (`admins` / `doulas`) while several paths
still targeted removed Supabase `public.users`.
