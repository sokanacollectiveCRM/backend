...
async function addFieldsToTemplate() {
  try {
    console.log('🔍 Adding fields to existing template...');
    ...
    // First, get the current template to see what fields exist
...
// Run the script
addFieldsToTemplate().then((result) => {
  if (result.success) {
    console.log('\n🎉 Fields added to template successfully!');
    console.log('📋 Summary:');
    ...
    console.log('\n❌ Failed to add fields to template');
