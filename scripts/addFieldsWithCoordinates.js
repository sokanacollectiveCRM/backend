...
async function addFieldsWithCoordinates() {
  try {
    console.log('🔍 Adding fields with specific coordinates to template...');
    ...
    // Add fields with specific coordinates
    console.log('🔧 Adding fields with specific coordinates...');
...
// Run the script
addFieldsWithCoordinates().then((coordinates) => {
  if (coordinates) {
