-- Scenario: Self-Pay + signed contract + paid deposit + no card on file
...
-- Manual psql (no extra quotes around UUID):
--   psql -h 127.0.0.1 -p 5433 -U app_user -d sokana_private -v client_id="$CLIENT_ID" -f scripts/test/scenario-selfpay-missing-card.sql
