-- Scenario: Self-Pay + signed contract + paid deposit + card on file
-- Expected API: is_eligible=true, primary_portal_blocker=null
-- Usage: ./scripts/test/run-portal-readiness-scenario.sh selfpay-eligible-with-card
