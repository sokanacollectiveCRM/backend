...
async function updateTemplateWithLatestCoordinates() {
  try {
    console.log(
      '🔍 Updating Labor Support template with latest accurate coordinates...'
    );
    ...
    // Latest accurate coordinates from the working document
    console.log('🔧 Updating template with latest accurate coordinates...');
      ...
      fields: [
        {
          ...
          height: 25,
          width: 150,
          x: 400, // Latest accurate x coordinate
          y: 251, // Latest accurate y coordinate
        },
        {
          page_number: 2, // Last page (0-based indexing)
          type: 'text',
          ...
          height: 25,
          width: 120,
          x: 105, // Latest accurate x coordinate
          y: 299, // Latest accurate y coordinate
          label: 'Date',
        },
      ],
    };
    ...
    console.log('✅ Template updated with latest accurate coordinates');
    ...
    if (verifyResponse.data.fields && verifyResponse.data.fields.length > 0) {
      console.log('✅ Verification - Template updated successfully:');
      ...
      console.log('const updatedFieldCoordinates = {');
      ...
      console.log(
        '\n🎉 Labor Support template updated with latest accurate coordinates!'
      );
      console.log('The template now uses the proven working field positions.');
      console.log(
      ...
      console.log('❌ No fields found after updating template');
      return null;
    }
  } catch (error) {
...
// Run the script
updateTemplateWithLatestCoordinates().then((coordinates) => {
  if (coordinates) {
    console.log('\n🎉 Template coordinates updated successfully!');
    console.log(
      'The Labor Support template now uses the latest accurate field positions.'
    );
    console.log(
      '\n💡 Future contract generations will use these proven coordinates.'
    );
  } else {
    console.log('\n❌ Failed to update template coordinates');
  }
});
