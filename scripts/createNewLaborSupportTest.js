...
async function createNewLaborSupportTest() {
  try {
    console.log('🔍 Creating new Labor Support contract for testing...');
    ...
    // Use our Labor Support template with perfect coordinates
    ...
    form.append('file', downloadResponse.data, {
      filename: 'Labor Support Agreement - Test Contract.docx',
    ...
    // Add fields with our perfect coordinates
    ...
    console.log('\n📋 New Labor Support Test Contract:');
    console.log('===================================');
...
// Run the script
createNewLaborSupportTest().then((result) => {
  if (result) {
    console.log('\n🎉 New Labor Support test contract created successfully!');
    ...
    console.log('\n💡 This contract is ready for testing field positioning!');
  } else {
    console.log('\n❌ Failed to create Labor Support test contract');
  }
});
