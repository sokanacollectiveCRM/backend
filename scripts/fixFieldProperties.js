...
async function fixFieldProperties() {
  try {
    console.log('🔍 Fixing field properties in SignNow document...');
    ...
    // Create properly formatted fields with all required properties
    const fieldData = {
    ...
    console.log('🔧 Updating fields with proper properties...');
    ...
    // Test sending an invitation now that fields are properly formatted
