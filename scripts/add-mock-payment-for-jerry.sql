-- Add Mock Payment Data for jerry@techluminateacademy.com
-- This script creates a contract and payment for the specified client

DO $$
DECLARE
  v_client_email TEXT := 'jerry@techluminateacademy.com';
  v_client_id UUID;
  v_contract_id UUID;
  v_payment_id UUID;
BEGIN
  RAISE NOTICE 'Adding mock payment data for %...', v_client_email;
  ...
  IF v_contract_id IS NULL THEN
    ...
    VALUES (
      ...
      '3000',
      '600',
      'Mock contract for testing - Jerry',
      NOW(),
      NOW()
    )
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Mock payment data added successfully!';
  RAISE NOTICE '========================================';
