// Upload Labor Support Contract directly using the SignNow service
// This bypasses the API routes and uses the service directly
...
async function uploadLaborSupportDirect() {
  try {
    console.log('🚀 UPLOADING LABOR SUPPORT CONTRACT DIRECTLY USING SIGNNOW SERVICE\n');
    ...
    // 6️⃣ Create signing invitation using the more robust method
...
// Run the upload
uploadLaborSupportDirect().catch(console.error);
